...
function makeMap() {
    main_map.on('load', function() {
        ...
        main_map.loadImage('https://pvis2023.github.io//pvis2023/assets/images/maps/5_3star.png', function(error, image) {
            if(error) throw error;
            main_map.addImage('5_star', image);
        });

        main_map.loadImage('https://pvis2023.github.io//pvis2023/assets/images/maps/4_3star.png', function(error, image) {
            if(error) throw error;
            main_map.addImage('4_star', image);
        });

        main_map.loadImage('https://pvis2023.github.io//pvis2023/assets/images/maps/3_3star.png', function(error, image) {
            if(error) throw error;
