var lunch_data = {
    1 : [
        {
            'Korean': '떡갈비',
            'English': 'Grilled Short Rib Patty',
            'Roman': 'Tteokgalbi',
            'isKorean': true,
            'vegetarian': 'None'
        },
        {
            'Korean': '간장소스 스테이크 & 채소 가니쉬',
            'English': 'Soy Sauce Steak & Vegetable Garnish',
            'isKorean': false,
            'vegetarian': 'None'
        },
        {
            'Korean': '브로컬리비프',
            'English': 'Broccoli Beef',
            'isKorean': false,
            'vegetarian': 'None'
        }
    ],
    ...
    4: [
        {
            'Korean': '유부초밥 3종 (크래비&오이, 불고기, 야채)',
            'English': 'Fried Bean Curd Rice Ball (Crammy&Cucumber, Bulgogi, Vegetable)',
            'isKorean': false,
            'vegetarian': 'Partially Vegan',
            'vegan_part': 'Vegetable'
        },
        {
            'Korean': '쌈밥 박스 (유부 2종, 케일, 명이, 깻잎)',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': '비건'
        ...
        {
            'Korean': '생선초밥 (연어, 크래미, 문어, 계란) <br> 롤 (아보카도, 훈제연어, 새싹, 치즈)',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': 'Partially Vegan',
            'vegan_part': '아보카도;새싹;치즈'
        }
    ],
    5: [
        {
            'Korean': '크라상샌드위치 (햄치즈, 구운야채)',
            'English': 'Croissant Sandwich (Ham&Cheese, Grilled Vegetable)',
            'isKorean': false,
            'vegetarian': 'Partially Vegan',
            'vegan_part': 'Grilled Vegetable'
        },
        {
            'Korean': '카야 햄치즈 크로와상 샌드위치',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': 'None'
    ...
    6: [
        {
            'Korean': '훈제연어샐러드;두부면샐러드',
            'English': 'Smoked Salmon Salad;Bean Curd Noodles Salad',
            'isKorean': false,
            'vegetarian': 'Partially Vegan',
            'vegan_part': '두부면샐러드'
        },
        {
            'Korean': '오리엔탈 드레싱 두부 샐러드',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': 'Vegan'
    ...
    8: [
        {
            'Korean': '비건도시락 (두부스테이크)',
            'English': 'Vegan Lunch Box (Bean Curd Steak)',
            'isKorean': false,
            'vegetarian': 'Only Vegan'
        },
        {
            'Korean': '비건도시락 (콩고기 & 채소가니쉬)',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': 'Only Vegan'
        ...
        {
            'Korean': '비건도시락 (두부 스테이크, 샐러드, 해시브라운, 수제 애플파이 등)',
            'English': '',
            'Roman': '',
            'isKorean': ,
            'vegetarian': 'Only Vegan'
...
var reception = [
    ...
    {
        'Korean': '순살치킨',
        'English': 'Fried Boneless Chicken'
    },
    {
        'Korean': '먹태구이',
        'English': 'Grilled Dried Pollack'
    },
    {
        'Korean': '멕시칸 나초 콤보',
        'English': 'Mexican Nacho Combo'
    },
    {
        'Korean': '생맥주(무제한)',
